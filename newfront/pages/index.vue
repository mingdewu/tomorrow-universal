...
export default {
  components: { LayoutWrapper, BaseHeading, LayoutHeader },
  name: 'IndexPage'
}
</script>
...
<style>
.visual-home {
  background-image: url("~@/assets/img/tomorrow-home2.jpg");
}
</style>
